...
_settings2.default.setIcons({
  ...
  checkbox: _react2.default.createElement(
    ...
    _react2.default.createElement('path', { d: 'M20.782.708H3.218c-1.38 0-2.51 1.13-2.51 2.51v17.564c0 1.38 1.13 2.51 2.51 2.51h17.564c1.38 0 2.51-1.13 2.51-2.51V3.218c0-1.38-1.13-2.51-2.51-2.51z' })
  ),
  'checkbox-checked': _react2.default.createElement(
    'svg',
    { height: '24', width: '24', viewBox: '0 0 24 24' },
    _react2.default.createElement('path', { d: 'M20.774.72H3.226C1.846.72.72 1.846.72 3.225v17.548c0 1.38 1.127 2.507 2.506 2.507h17.548c1.38 0 2.507-1.127 2.507-2.506V3.226c0-1.38-1.127-2.507-2.506-2.507zM9.494 18.266L3.225 12l1.754-1.755 4.513 4.513L19.02 5.23l1.754 1.756-11.28 11.28z' })
  )
});
