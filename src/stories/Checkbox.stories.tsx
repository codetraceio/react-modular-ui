...
configService.setConfig({
  icons: {
    ...
    pagination: (
      <svg viewBox="0 0 24 24">
        <path d="M5.875 11.998l8.214-8.553c.205-.212.2-.56-.01-.777l-1.47-1.503c-.21-.216-.555-.22-.762-.01L1.818 11.6c-.11.108-.158.255-.15.398-.003.147.046.29.15.397l10.03 10.45c.207.21.55.206.762-.01l1.47-1.503c.21-.217.215-.565.01-.777l-8.215-8.557z" />
      </svg>
    ),
    dropdown: (
